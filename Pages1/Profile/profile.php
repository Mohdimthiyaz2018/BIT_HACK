    ...
    <div class="box">
      <form action="profileProcess.php" method="POST" id="profileForm">
        <div class="proDitl" id="eProfile">
            ...
            <div class="subHead">:</div>
            <div class="subBody">
              <input name="roll_no" type="text" onkeyup="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')" id="rNo" required />
            </div>
...
<?php }else { ?>
        ...
        <div class="box">
            <div class="profile">
                <div>
                    <img src="<?php echo $_SESSION['user_image']; ?>" alt="<?php echo $_SESSION['name']; ?>" alt="Profile Picture" class="proPicM" width="300px" height="300px">
                </div>
