...
$client->setClientId('655964990720-uno0nb9fdaqkoosgdepeknqek6tvge1s.apps.googleusercontent.com');
$client->setClientSecret('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');
$client->setRedirectUri('http://localhost/SkillsBIT/admin_login.php');
...
if(isset($_GET['code'])) {
    ...
    if(!isset($token["error"])){
        ...
        $_SESSION['dean'] = null;
        $_SESSION['mteam'] = null;
        if($_SESSION['email'] == 'mohamedimthiyaz.it19@bitsathy.ac.in' || $e == 'mohdimthiyaz2018@gmail.com') {
            $_SESSION["admin_login_id"] = true;
        }
        if($_SESSION['email'] == 'mohdimthiyaz2018@gmail.com')
        {
            $_SESSION['dean'] = true;
        }
        if($_SESSION['email'] == 'mohamedimthiyaz.it19@bitsathy.ac.in' || $e == 'deanpds@bitsathy.ac.in')
        {
            $_SESSION['mteam'] = true;
        } 
        header("location:./Admin/Home/home.php");
