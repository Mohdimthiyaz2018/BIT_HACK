...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="problamStatements.css" />
  ...
  <body>
    ...
    <!-- HEAD END -->
    <div class="body">
      <div class="title">PROBLAM STATEMENTS</div>
      <div class="tabel"> 
      <div class="grid-container">
        <div class="grid-container-body tabelHead">
        <div class="grid-item-head">PROBLAM_CODE</div>
          <div class="grid-item-head">TOPIC</div>
          <div class="grid-item-head">DESCRIPTION</div>
          <div class="grid-item-head"></div>
        </div>
        <div >
          <form class="grid-container-body tabelBody" method="POST" action="../ViewProblam/viewProblam.php">
